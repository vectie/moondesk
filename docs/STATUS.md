...
- Finish the MoonClaw autonomous MoonCode loop that chooses tools from prompts,
  resumes/steers multi-turn coding work, and publishes passing tool-harness plus
  file-edit eval evidence.
