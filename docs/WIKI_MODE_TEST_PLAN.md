...
moon run cmd/main --target native -- lepusa live-smoke macos --strict --serve-port <free-port> --workspace-root /path/to/moonsuite --ui ui/rabbita-desk/dist --out _build/lepusa/<run-id>
