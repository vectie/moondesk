...
run_step "MoonCode model-planner evidence contract ownership" bash "${ROOT}/scripts/validate_mooncode_model_planner_evidence_contract.sh"
run_step "MoonCode runtime-control contract ownership" bash "${ROOT}/scripts/validate_mooncode_runtime_control_contract.sh"
run_step "MoonCode runtime-consumer contract ownership" bash "${ROOT}/scripts/validate_mooncode_runtime_consumer_contract.sh"
...
run_step "MoonCode native command execution contract ownership" bash "${ROOT}/scripts/validate_mooncode_native_command_execution_contract.sh"
run_step "MoonCode runtime evidence contract ownership" bash "${ROOT}/scripts/validate_mooncode_runtime_evidence_contract.sh"
