...
const zhHans = {
  ...
  "MoonClaw is not installed": "MoonClaw 尚未安装",
  "MoonClaw is required for Code and AI actions. MoonDesk can download, verify, install, and start it for this workspace.": "代码和 AI 操作需要 MoonClaw。MoonDesk 可以为此工作区下载、校验、安装并启动它。",
  "Install MoonClaw": "安装 MoonClaw",
  "Installing MoonClaw…": "正在安装 MoonClaw…",
